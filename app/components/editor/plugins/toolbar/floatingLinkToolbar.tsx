...
import { setFloatingElemPositionForLinkEditor } from "../../utils/get-floating-elem-position";
...
function FloatingLinkEditor({
  ...
  return (
    <div
      ref={editorRef}
      className="absolute bg-white top-9 left-0 w-full max-w-sm rounded-md opacity-0 shadow-md"
    >
