...
const plans = [
  {
    ...
    icon: <Zap size={18} />,
    features: [
      " High-converting landing page (custom built)",
      " Basic SEO setup",
      " 3 performance ad creatives",
      " Audience research & targeting setup",
      "Paid social ad campaign setup (Meta / TikTok)",
  ...
  },
  {
    ...
    features: [
      "Everything in Lite",
      "Full website (5–8 pages, custom built)",
      "Advanced SEO setup",
      " 5 performance ad creatives",
      "Audience research & targeting setup ",
      "Multi-platform ad campaign setup (Meta, Google & TikTok)",
      "Multi-step sales funnel setup",
      "Conversion tracking & pixel integration",
      "Creative A/B testingg",
    ...
    <section id={"pricing"} className="min-h-screen pt-20 pb-20 font-cormorant">
      ...
      <div className="w-[93%] lg:max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl lg:text-6xl font-Cormorant font-normal text-gray-900  mb-3 flex flex-wrap items-center tracking-tight justify-center gap-2 font-cormorant">
